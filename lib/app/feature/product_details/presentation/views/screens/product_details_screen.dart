            ...
            builder: (context, state) {
              if (state.productDetailsState?.isLoading == true) {
                return Center(child: CircularProgressIndicator(),);
                  ...
                  state.productDetailsState?.success != null) {
                return CustomScrollView(
                  slivers: [
                    SliverAppBar(
                      pinned: true,
                      leading: InkWell(
                        child: Icon(Icons.arrow_back_ios_rounded), onTap: () {
                        ...
                        background: Container(
                          ...
                          child: SizedBox(
                            ...
                            child: CarouselView(itemExtent: width,
                              ...
                              itemSnapping: true,
                              children: state.productDetailsState!.success!
                                  .images!.map((e) {
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Text("${AppLocale(context).egp} ${state
                                .productDetailsState!.success!.price}",
                              style: Theme
                                  .of(context)
                                  .textTheme
                                  .headlineLarge,),
                            Spacer(),
                            Text("${AppLocale(context).status} :", style: Theme
                                .of(context)
                                .textTheme
                                .headlineLarge),
                            Text(
                                state.productDetailsState!.success!.quantity! <=
                                    0
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 16),
                        child: Text(
                          state.productDetailsState!.success!.title ?? "",
                          style: Theme
                              .of(context)
                              .textTheme
                              .headlineMedium,),
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 16),
                        child: Text(AppLocale(context).description, style: Theme
                            .of(context)
                            .textTheme
                            .headlineLarge,),
                      ),
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 16),
                        child: Text(
                          state.productDetailsState!.success!.description ?? "",
                          style: Theme
                              .of(context)
                              .textTheme
                              .headlineMedium,),
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 16),
                        child: Text(
                          AppLocale(context).bouquetinclude, style: Theme
                            .of(context)
                            .textTheme
                            .headlineLarge,),
                      ),
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(onPressed: () {
                          viewModel.doIntent(AddToCartAction(
                            ...
                            context).add_to_cart, style: TextStyle(
                            fontSize: 20),)),
                      ),
                    ),
                  ],
                  ...
                  state.productDetailsState?.error != null) {
                return Center(
