...
class AddProductToCartUsecase {
  ...
  Future<BaseResponse<UpdateCartModel>> call({String? productId, int? quantity}) {
    var response = productDetailsRepoContract.addProductToCart(productId: productId, quantity: quantity);
    return response;
  }
}