...
class ResetPasswordViewModel
    extends CustomCubit<ResetPasswordEvent, ResetPasswordState> {
  final ResetPasswordUseCase _resetPasswordUseCase;

  ResetPasswordViewModel(this._resetPasswordUseCase)
    : super(ResetPasswordState(resetPasswordState: BaseState()));
  ...
  void _resetPassword(ResetPasswordRequest resetPasswordRequest) async {
    ...
    switch (result) {
      ...
      case ErrorResponse<ResetPasswordResponse>():
        emit(
          state.copyWith(resetPasswordState: BaseState(error: result.error)),
        );
        break;
    }
  }
