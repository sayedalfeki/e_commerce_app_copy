...
class ForgetPasswordScreenBody extends StatefulWidget {
  ...
  const ForgetPasswordScreenBody({super.key,required this.forgetPasswordViewModel,required this.emailController});
    ...
    child: Form(
      ...
      child: Column(
        ...
        children: [
          ...
          ForgetPasswordAction(ForgetPasswordRequest(email: widget.emailController.text)),
          );
          }
