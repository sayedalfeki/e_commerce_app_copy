...
class ForgetPasswordViewModel
    extends CustomCubit<ForgetPasswordEvent, ForgetPasswordState> {
  final ForgetPasswordUseCase _forgetPasswordUseCase;

  ForgetPasswordViewModel(this._forgetPasswordUseCase)
    : super(ForgetPasswordState(forgetPasswordState: BaseState()));
  ...
  void _forgetPassword(ForgetPasswordRequest forgetPasswordRequest) async {
    ...
    switch (result) {
      case SuccessResponse<ForgetPasswordResponse>():
        emit(
          state.copyWith(forgetPasswordState: BaseState(success: result.data)),
        );
        break;
      case ErrorResponse<ForgetPasswordResponse>():
        emit(
          state.copyWith(forgetPasswordState: BaseState(error: result.error)),
        );
        break;
    }
  }
